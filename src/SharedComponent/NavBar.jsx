...
const NavBar = () => {
    ...
    const navItems = <>
        ...
        <li><NavLink className='ml-5 font-semibold text-lg' to='/'>Home</NavLink></li>
        <li><NavLink className='ml-5 font-semibold text-lg' to='/rooms'>Rooms</NavLink></li>
        {
            user && <li><NavLink className='ml-5 font-semibold text-lg' to='/my-Bookings'>My Bookings</NavLink></li>
        }
        <li><NavLink className='ml-5 font-semibold text-lg' to='/gallery'>Gallery</NavLink></li>
        <li><NavLink className='ml-5 font-semibold text-lg' to='/about-us'>About Us</NavLink></li>
    </>
