        ...
        <div className="hero h-[60vh] z-0  md:h-[92vh] mb-16 md:mb-0 relative dark:bg-black " style={{ backgroundImage: 'url(https://t3.ftcdn.net/jpg/00/29/13/38/360_F_29133877_bfA2n7cWV53fto2BomyZ6pyRujJTBwjd.jpg)' }}>
            ...
            <div className="hero-content text-center text-neutral-content absolute  top-[13vh] md:top-[25vh] lg:top-[30vh]">
                <div className="max-w-5xl ">
                    <h3 data-aos="zoom-in" data-aos-duration="2000" className=' text-2xl md:text-4xl lg:text-5xl font-serif font-bold mt-10' >Welcome to StayNest Hotel</h3>
                    ...
                    <Link data-aos="fade-up"
                        data-aos-duration="2000" className=" border mt-4 md:mt-10 border-white py-2 px-3 md:py-3 md:px-6 font-semibold md:font-bold hover:bg-white hover:text-[#079988]" to='/rooms'>BOOK NOW</Link>
