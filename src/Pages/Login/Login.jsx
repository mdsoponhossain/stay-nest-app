...
const Login = () => {
    ...
    return (
        <div className="hero min-h-screen w-full dark:bg-black dark:text-white text-black bg-white">
            <Tittle  title='stay-nest/login'/>
            <div className="md:hero-content w-full flex-col ">

                <div className="card flex-shrink-0 w-full dark:bg-black dark:text-slate-300  md:w-[400px] h-fit  bg-base-100">
                    ...
                    <form onSubmit={handleLogInFormSubmit} className=" dark:bg-black dark:text-slate-300 card-body w-full">
                        ...
                        <div className="form-control">
                            ...
                            <input type="email" autoComplete="username" name="email" placeholder="Enter Your Email" className="input input-bordered" required />
                        </div>
                        <div className="form-control">
                            <label className="label">
